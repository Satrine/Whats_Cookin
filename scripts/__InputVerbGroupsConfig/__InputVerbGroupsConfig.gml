...
function __InputVerbGroupsConfig()
{
	...
	InputVerbGroupDefine(INPUT_VERB_GROUP.MENU_VERB, [INPUT_VERB.UP, INPUT_VERB.DOWN, INPUT_VERB.LEFT, INPUT_VERB.RIGHT, INPUT_VERB.ACCEPT, INPUT_VERB.CANCEL]);
	InputVerbGroupDefine(INPUT_VERB_GROUP.GAME_VERB, [INPUT_VERB.UP, INPUT_VERB.DOWN, INPUT_VERB.LEFT, INPUT_VERB.RIGHT, INPUT_VERB.ACTION, INPUT_VERB.SPECIAL]);
